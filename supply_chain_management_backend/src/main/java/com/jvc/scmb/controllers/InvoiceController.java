...
public class InvoiceController {
	...
	public InvoiceResponseDto assignEmployee(@PathVariable Long id, @RequestHeader (name="Authorization") String token) {
		return invoiceService.assignEmployee(id, token);
	}
}
